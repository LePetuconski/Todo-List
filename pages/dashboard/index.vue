                    ...
                    <div class="widget-content p-0">
                      <div class="widget-content-wrapper">
                        ...
                        <div class="widget-content-left">
                          ...
                          <div class="widget-subheading">Trabalho - ({{ new Date(task.date).toLocaleDateString('pt-BR', { hour: 'numeric', minute: 'numeric' }) }})</div>
                        </div>
                        <div class="widget-content-right"> <button
                            ...
                            class="border-0 btn-transition btn btn-outline-danger"> <i class="fa fa-trash"></i>
                          </button> </div>
                      </div>
                    </div>
